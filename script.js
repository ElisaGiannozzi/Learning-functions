...
console.log(replaceCharacter('you drink coffee'));
...
function yearCalculator(birthYear, year) {
    if (year > birthYear) {
        result = `You will be born in ${year - birthYear} years`;   
    } else if (birthYear > year) {
        result = `You are ${birthYear - year} years old`; 
    } else if (birthYear === year) {
